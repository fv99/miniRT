...
#    Updated: 2024/08/31 16:19:32 by fvonsovs         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS		=	minirt.c controls.c parser.c parser_scene.c parser_objects.c \
				...
				utils_vec.c utils_vec2.c utils_win.c render_intersects.c render_intersect_cylinder.c \
				utils_col.c utils_col2.c render.c render_view.c render_illumination.c
OBJS		=	${SRCS:.c=.o}
LIBC		=	ar -cq
RM			=	rm -f
LIBFT		=	./libft/libft.a
